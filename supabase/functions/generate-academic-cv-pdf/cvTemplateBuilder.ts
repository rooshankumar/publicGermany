...
.header { display: flex; align-items: flex-start; gap: 18px; margin-bottom: ${dens.sec}; padding-bottom: 10px; }
.photo-box {
  width: 96px; height: 96px; border-radius: 50%;
  border: 2px solid var(--accent);
  flex-shrink: 0; overflow: hidden; background: #e8f0f5;
  display: flex; align-items: center; justify-content: center;
  font-size: 9px; color: #888;
}
.photo-box img { width: 100%; height: 100%; object-fit: cover; object-position: center top; }
.header-info { flex: 1; }
.header-name { font-size: ${dens.name}; font-weight: 700; color: var(--accent); letter-spacing: 0.5px; margin-bottom: 10px; line-height: 1.1; }
.contact-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 3px 20px; }
.contact-item { font-size: 9.5px; color: #333; display: flex; gap: 5px; word-break: break-word; }
...
.section-title {
  ...
  margin-bottom: 8px; border-bottom: 1px solid #d0d0d0; padding-bottom: 4px;
  page-break-after: avoid; break-after: avoid;
}
.section-dot { width: 10px; height: 10px; border-radius: 50%; background: var(--accent); flex-shrink: 0; }
.section-title h2 { font-size: 11.5px; font-weight: 700; color: var(--accent); letter-spacing: 0.5px; text-transform: uppercase; }

.edu-entry { margin-bottom: ${dens.entryGap}; padding-bottom: 8px; page-break-inside: avoid; break-inside: avoid; }
.edu-entry + .edu-entry { border-top: 1px dashed #ececec; padding-top: 8px; }

.entry-row { display: flex; justify-content: space-between; align-items: baseline; gap: 12px; margin-bottom: 2px; }
.entry-left { font-weight: 700; font-size: 10.5px; color: var(--accent); text-transform: uppercase; letter-spacing: 0.3px; flex: 1; }
.entry-inst { font-weight: 500; font-style: italic; color: #444; text-transform: none; letter-spacing: 0; }
.entry-dates { font-size: 9.5px; color: var(--accent); font-weight: 600; white-space: nowrap; flex-shrink: 0; }
...
.edu-desc, .entry-desc { font-size: 9.5px; color: #444; line-height: 1.55; margin-top: 3px; }
.edu-desc strong, .entry-desc strong { color: var(--accent); font-weight: 700; }
.edu-desc p, .entry-desc p { margin: 2px 0; }
.edu-desc ul, .entry-desc ul, .blist { list-style: none; padding-left: 0; margin: 3px 0; }
.edu-desc ol, .entry-desc ol { list-style: decimal; padding-left: 16px; margin: 3px 0; }
.edu-desc li, .entry-desc li, .blist li { font-size: 9.5px; color: #444; padding-left: 12px; position: relative; margin-bottom: 2px; line-height: 1.5; }
.edu-desc li::before, .entry-desc li::before, .blist li::before { content: '•'; position: absolute; left: 0; color: var(--accent); font-size: 11px; line-height: 1; }

.mother-tongue, .other-lang { font-size: 10px; margin-bottom: 4px; }
.mother-tongue strong, .other-lang strong { color: var(--accent); }
.lang-table { width: 100%; border-collapse: collapse; font-size: 9px; margin-top: 4px; page-break-inside: avoid; }
.lang-table th { background: var(--accent); color: #fff; padding: 5px 6px; text-align: center; font-weight: 600; font-size: 8.5px; border: 1px solid var(--accent); }
.lang-table th.lang-name-header { text-align: left; padding-left: 8px; }
.lang-table td { padding: 5px 6px; text-align: center; border-bottom: 1px solid #e8e8e8; border-right: 1px solid #e8e8e8; font-size: 9px; }
